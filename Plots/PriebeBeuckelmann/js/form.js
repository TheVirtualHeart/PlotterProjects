/**
  ...
  * of the plot, describing what variables are plotted and how the Priebe-Beuckelmann 
  * differential equation is calculated.
*/
define(["utility"],
function PriebeBeuckForm(utils) {
  "use strict";
  var mediator;
  /**
  ...
  */
  function initialize(defaultSettings, mediatorObj){
    ...
    */
        ...
        var   formCtrls    =  [ "displayAPDDI","displayV", "displayS1S2","displayCansr", "displayNai","displayKi",
    "displayD","displayF","displayM", "displayH", "displayJ",
    "displayR","displayTo","displayXr", "displayXs", "displayCajsr",
    "displayCai", "secondaryPlot"],                                                     
    settingCtrls = ["s1","s2","ns1","gna","gca","gto","gkr","gks","gk1","gnaca"];              
