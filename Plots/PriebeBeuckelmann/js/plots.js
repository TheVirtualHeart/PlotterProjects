...
*/
define(["utility"],
function PriebeBeuckPlots(utils) {
  "use strict";
  ...
  */
  function drawPlots(settings) {
        ...
        // draw the main plot
        app.selectPlot("PriebeBeuck");
        _resizePlots("PriebeBeuck", 
        settings.plotSettings.PriebeBeuck, 
      ...
      app.ctx.fillText(APDText, 400, 30);
        ...
        var voltagePlots =  [ {key: "v",value: "Red"},
    {key: "cansr",value: "Maroon"},{key: "nai",value: "Gray"},
    {key: "ki",value: "MidnightBlue"},{key: "d",value: "Pink"},
    {key: "f",value: "SandyBrown"},{key: "m",value: "Purple"},{key: "h",value: "Teal"},
    {key: "j",value: "YellowGreen"},{key: "r",value: "Violet"},
    {key: "to",value: "SpringGreen"},{key: "xr",value: "LightCoral"},
    {key: "xs",value: "Olive"},{key: "cajsr",value: "Yellow"},
    {key: "cai",value: "OrangeRed"} ];
      ...
      app.plotText(" S2", textPoint);
        ...
        app.selectPlot("PriebeBeuckOther");
      ...
      _resetPointsForSecondaryPlot(settings, "PriebeBeuckOther")
    }
    
        _resizePlots("PriebeBeuckOther",
        settings.plotSettings.PriebeBeuckOther, 
        settings.calculationSettings, 
