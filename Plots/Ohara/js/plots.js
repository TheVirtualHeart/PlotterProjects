...
function OharaPlots(utils) {
  ...
  */
  function drawPlots(settings) {
        ...
        // draw the main plot
        app.selectPlot("Ohara");
        _resizePlots("Ohara", 
        settings.plotSettings.Ohara, 
      ...
      app.ctx.fillText(APDText, 400, 30);
        ...
        var voltagePlots =  [ {key: "v", value: "Red"},  {key: "nai", value: "Blue"}, 
                              {key: "nass", value: "Aqua"}, {key: "ki", value: "Yellow"},
                              {key: "kss", value: "Black"}, {key: "cai", value: "Indigo"},  
                              {key: "cass", value: "YellowGreen"},  {key: "cansr", value: "Purple"},
                              {key: "cajsr", value: "Pink"},  {key: "xm", value: "Gray"},
                              {key: "xhf", value: "Orange"},  {key: "xhs", value: "LightBlue"},
                              {key: "xj", value: "Green"},  {key: "xhsp", value: "LightCoral"},
                              {key: "xjp", value: "LightSlateGray"},  {key: "xml", value: "Maroon"},  
                              {key: "xhl", value: "MidnightBlue"},  {key: "xhlp", value: "OrangeRed"}, 
                              {key: "xa", value: "SandyBrown"}, {key: "xif", value: "Teal"},  
                              {key: "xis", value: "Violet"},  {key: "xap", value: "SpringGreen"},
                              {key: "xifp", value: "Olive"},  {key: "xisp", value: "BlueViolet"}, 
                              {key: "xd", value: "Brown"},  {key: "xff", value: "BurlyWood"},
                              {key: "xfs", value: "Chartreuse"},{key: "xfcaf", value: "Chocolate"},                              
                              {key: "xfcas", value: "CornflowerBlue"}, {key: "xjca", value: "DarkGoldenRod"},                             
                              {key: "xnca", value: "DarkMagenta"},{key: "xffp", value: "DarkSlateGrey"},
                              {key: "xfcafp", value: "FireBrick"},{key: "xrf", value: "Lime"},
                              {key: "xrs", value: "SaddleBrown"},{key: "xs1", value: "Turquoise"},
                              {key: "xs2", value: "CadetBlue"},{key: "xk1", value: "DarkGreen"},
                              {key: "jrelnp",value: "DarkRed"},{key: "jrelp", value:"DarkSalmon"},
                              {key: "camkt",value: "DeepPink"}];
      ...
      _resetPointsForSecondaryPlot(settings, "OharaOther")
    }
    
        _resizePlots("OharaOther",
        settings.plotSettings.OharaOther, 
        settings.calculationSettings, 
  ...
  */
  ...
  function _resetPointsForSecondaryPlot(settings, plotName){
      ...
      selectedPlot["range"]           = new Point((pMinMax["x"] - (Math.abs(pMinMax["x"]) * .1)), (pMinMax["y"] + (Math.abs(pMinMax["y"]) * .1)));
