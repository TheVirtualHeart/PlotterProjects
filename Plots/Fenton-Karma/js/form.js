...
*/
define(["utility"],
function FentonKarmaForm(utils) {
    "use strict";
    ...
    */
    ...
    formCtrls  = [ "displayAPDDI","displayS1S2","displayU","displayV", "displayW", "secondaryPlot"],
    settingCtrls    = ["s1", "s2", "ns1","tvp", "tv1m", "tv2m", "twp", "twm", "td", "to", "tr", "tsi", "xk", 
                        "xk", "ucsi", "uc", "uv"]; // includes parameters parameters
