/**
  ...
  * of the plot, describing what variables are plotted and how the LiRudy 
  * differential equation is calculated.
  */
  define(["utility"],
    function LiRudyForm(utils) {
      "use strict";
      var mediator;
  /**
  ...
  var   formCtrls    =  [ "displayAPDDI", "displayS1S2", "displayV", "displayM", "displayH", 
  "displayJ", "displayD", "displayF", "displayF2", "displayFca", 
  "displayFca2", "displayXs1", "displayXs2", "displayXr", "displayA", 
  "displayI", "displayI2", "displayMl", "displayMl3", "displayHl", 
  "displayHl3", "displayJl", "displayJl3", "displayCasss", "displayCajsr", 
  "displayCacsr", "displayCansr", "displayCassl",  "displayNai", "displayNassl", 
  "displayNasss", "displayKi", "displayCai", "displayB", "displayG", 
  "displayU", "displayY", "displayCamktrap", "secondaryPlot"],                                                             
  settingCtrls = ["s1","s2","ns1", "gna", "pca", "gcat", "gtof", "gtos", "gkr", "gks", "gk1","inacamax"];
