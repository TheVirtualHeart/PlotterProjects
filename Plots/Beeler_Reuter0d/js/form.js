/**
  ...
  * of the plot, describing what variables are plotted and how the BeelerReuter 
  * differential equation is calculated.
*/
define(["utility"],
function BeelerReuterForm(utils) {
  "use strict";
  var mediator;
  /**
  ...
  */
  ...
  var   formCtrls    =  ["displayAPDDI", "displayS1S2", "displayV", "displayM", "displayH", "displayJ", "displayD", 
                         "displayF", "displayX1", "displayCai", "secondaryPlot"],                            
  settingCtrls = ["s1","s2","ns1","gna","gnac","gs"];
