/**
  ...
  * of the plot, describing what variables are plotted and how the Courtemanche 
  * differential equation is calculated.
  */
  define(["utility"],
    function CourtemancheForm(utils) {
      "use strict";
      var mediator;
  /**
  ...
  "displayXh"   , "displayXd"   , "displayXoa"  , "displayXua",
  "displayXr"   , "displayXfca" , "displayXv"   , "displayXm",
  "displayXj"   , "displayXf"   , "displayXoi"  , "displayXui", 
  "displayXs"   , "displayXu"   , "displayXw"   , "displayCcai",
  "displayCcaup","displayCcarel", "secondaryPlot"],
  
  settingCtrls = ["s1","s2","ns1","gna","gcal","gto","gks","gkr","gk1","xinacamax"];
