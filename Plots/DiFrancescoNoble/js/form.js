...
*/
define(["utility"],
function DiFrancescoForm(utils) {
    "use strict";
    ...
    */
    ...
    formCtrls  = [ "displayAPDDI","displayS1S2","displayV","displayY", "displayX",
            "displayR", "displayM", "displayH", "displayD", "displayF", "displayF2", "displayP",
            "displayCai",   "displayCaup",  "displayCarel", "displayNai",   "displayKi", 
            "displayKc", "secondaryPlot"],
    settingCtrls    = ["s1", "s2", "ns1", "gna", "psi", "gto", "ikmax", "gk1", "knaca" ]; // includes parameters parameters
        ...
        */
        function _appendHandler(ele, settingsParam){ 
            ele.addEventListener("change", function(e) {             
                if(ele.name === "s1" || ele.name === "s2"){
                    settingsParam[ele.name] = utils.getElementValue(ele) / utils.timeUnit.getTimeUnit(settingsParam.tUnit);
                }
                else{
