 ...
 define(["utility"],
     ...
     */
     function drawPlots(settings) {
            ...
            // draw the main plot
        app.selectPlot("Mahajan");
        _resizePlots("Mahajan", 
           settings.plotSettings.Mahajan, 
        ...
        var voltagePlots =  [
            ...
            {key: "xr",value: "YellowGreen"},   {key: "xs1",value: "Indigo"},
            {key: "xs2",value: "LightCoral"},   {key: "xtos",value: "MidnightBlue"},
            {key: "ytos",value: "SandyBrown"},  {key: "xtof",value: "Teal"},
            {key: "ytof",value: "Violet"},      {key: "cp", value: "OrangeRed"},
            {key: "cs", value: "LightBlue"},    {key: "ci", value: "Olive"},
            {key: "cj", value: "LightSlateGray"},{key: "cjp", value: "BlueViolet"},
            {key: "xir", value: "CadetBlue"},   {key: "xnai", value: "DarkMagenta"},
            {key: "tropi", value: "DarkSlateGrey"},{key: "trops", value: "FireBrick"},
            {key: "po", value: "Gold"}];
        ...
        if(settings.calculationSettings.pointBuffer.minMaxPoints){
          ...
          _resetPointsForSecondaryPlot(settings, "MahajanOther")
        }

        _resizePlots("MahajanOther",
        settings.plotSettings.MahajanOther, 
        settings.calculationSettings, 
      ...
      */
      ...
      function _resetPointsForSecondaryPlot(settings, plotName){
        ...
        if(settings.plotSettings[plotName]["plots"][secondaryPlot] && secondaryPlotMinMax){
          ...
          selectedPlot["unitPerTick"]     = new Point(200, Math.abs((secondaryPlotMinMax["y"] - secondaryPlotMinMax["x"] )/10)); 
