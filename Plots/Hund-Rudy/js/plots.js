 ...
 define(["utility"],
     ...
     */
     function drawPlots(settings) {
            ...
            // draw the main plot
        app.selectPlot("Hundrudy");
        _resizePlots("Hundrudy", 
           settings.plotSettings.Hundrudy, 
        ...
        var voltagePlots =  [{key: "v",value: "Red"},{key: "cai",value: "Aqua"},
            {key: "cajsr",value: "Gray"},       
            {key: "camktrap",value: "Purple"},  {key: "cansr",value: "YellowGreen"},
            {key: "car",value: "Indigo"},       {key: "cli",value: "LightCoral"},
            {key: "ki",value: "MidnightBlue"},  {key: "nai",value: "SandyBrown"},
            {key: "xa",value: "Teal"},          {key: "xaa",value: "Violet"},
            {key: "xd", value: "OrangeRed"},    {key: "xdpower", value: "LightBlue"},
            {key: "xf", value: "Olive"},        {key: "xf2", value: "LightSlateGray"},
            {key: "xfca", value: "BlueViolet"}, {key: "xfca2", value: "CadetBlue"},
            {key: "xh", value: "Brown"},        {key: "xhl", value: "BurlyWood"},
            {key: "xi", value: "Chartreuse"},   {key: "xi2", value: "Maroon"},
            {key: "xj", value: "CornflowerBlue"},{key: "xm", value: "DarkGoldenRod"},
            {key: "xml", value: "DarkMagenta"}, {key: "xr", value: "DarkSlateGrey"},
            {key: "xri", value: "FireBrick"},   {key: "xro", value: "Lime"},
            {key: "xs1", value: "SaddleBrown"}, {key: "xs2", value: "Turquoise"}];
        ...
        if(settings.calculationSettings.pointBuffer.minMaxPoints){
          ...
          _resetPointsForSecondaryPlot(settings, "HundrudyOther")
        }

        _resizePlots("HundrudyOther",
        settings.plotSettings.HundrudyOther, 
        settings.calculationSettings, 
      ...
      */
      ...
      function _resetPointsForSecondaryPlot(settings, plotName){
        ...
        if(settings.plotSettings[plotName]["plots"][secondaryPlot] && secondaryPlotMinMax){
          ...
          selectedPlot["unitPerTick"]     = new Point(250, Math.abs((secondaryPlotMinMax["y"] - secondaryPlotMinMax["x"] )/10)); 
