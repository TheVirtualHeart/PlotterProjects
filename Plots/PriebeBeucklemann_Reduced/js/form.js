/**
    ...
    * of the plot, describing what variables are plotted and how the PriebeBeuckelmannReducedForm 
    * differential equation is calculated.
*/
define(["utility"],
function PriebeBeuckelmannReducedForm(utils) {
    "use strict";
    ...
    */
    ...
    var  formCtrls   = [ "displayAPDDI","displayS1S2","displayV","displayXv","displayTo",
                        "displayF","displayXx","displayM","secondaryPlot"],        
        settingCtrls = ["s1", "ns1", "s2", "gNa", "gCa", "gto", "gK", "gK1", "gNaCa"]; // includes parameters parameters
