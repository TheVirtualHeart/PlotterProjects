...
*/
define(["utility"],
function BondarenkoPlots(utils) {
  "use strict";
  ...
  */
  function drawPlots(settings) {
    ...
    // draw the main plot
    app.selectPlot("Bondarenko");
    _resizePlots("Bondarenko", 
    settings.plotSettings.Bondarenko, 
    ...
    var voltagePlots =  [ {key: "v",value: "Red"} ,{key: "cai",value: "Aqua"},{key: "cass",value: "Gray"},
                          {key: "cajsr",value: "Pink"}, {key: "cansr",value: "Purple"},{key: "ltrpn",value: "YellowGreen"},
                          {key: "htrpn",value: "Indigo"}, {key: "nai",value: "LightCoral"},{key: "ki",value: "LightSlateGray"},
                          {key: "atof",value: "Maroon"}, {key: "itof",value: "MidnightBlue"},{key: "nks",value: "SandyBrown"},
                          {key: "atos",value: "Teal"}, {key: "itos",value: "Violet"},{key: "aur",value: "SpringGreen"},
                          {key: "iur",value: "Olive"}, {key:"xakss", value:"Yellow"},{key:"xikss", value:"OrangeRed"},
                          {key:"ol", value:"LightBlue"}, {key:"ona", value:"CadetBlue"},{key:"ok", value:"DarkGreen"}, {key:"pryr", value:"DarkRed"},
                          {key:"po12", value:"DarkSalmon"} ];
    ...
    app.selectPlot("BondarenkoOther");
    ...
    if(settings.calculationSettings.pointBuffer.minMaxPoints){
      ...
      _resetPointsForSecondaryPlot(settings, "BondarenkoOther")
    }
    
    _resizePlots("BondarenkoOther",
    settings.plotSettings.BondarenkoOther, 
    settings.calculationSettings, 
