define(["utility"],
  function PointBufferAnalyzer(utils) {
     ...
     */
     ...
     /**
     * This function resets the value
     */
 ...
 /*
     * This function extends the settings.calculationSettings.pointBuffer property 
     * and copies the the point value which are calculated previously in bufferSettings
     * for changes in graphs UI 
     * @param {settings} -  the object to be extended
     * function
     */   
